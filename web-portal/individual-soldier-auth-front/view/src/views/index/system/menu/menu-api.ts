...
export const GetMenuByRoleIdApi = (roleId: string): Promise<KWResponse.Result<Array<MenuRole>>> => request.get('menu/' + roleId)
...
export const DeleteSysMenuApi = (id: string): Promise<KWResponse.Result> => request.delete('menu/delete/' + id)
export const SysMuenSaveOrUpdateApi = (menuForm: MenuForm): Promise<KWResponse.Result> => request.post('menu/saveOrUpdate', menuForm)
export const GetMenuByIdApi = (id: string): Promise<KWResponse.Result<MenuResponse>> => request.get('menu/get/' + id)
