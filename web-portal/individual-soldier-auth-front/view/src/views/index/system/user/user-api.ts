...
import { LoginSuccessUserInfo, UserInfo, UserSearchRequest, UserStatuChange, UserForm, ModifyPassword } from './interface/sys-user'
...
export const UserStatuChangeRequestApi = (param: UserStatuChange): Promise<KWResponse.Result> => request.post('user/updateEnabled', param)
