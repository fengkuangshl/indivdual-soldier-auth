...
export const DeleteCustomerInfoApi = (id: string): Promise<KWResponse.Result> => request.delete('customer/delete/' + id)
export const CustomerInfoGetApi = (id: string): Promise<KWResponse.Result<CustomerInfoDetail>> => request.get('customer/get/' + id)
