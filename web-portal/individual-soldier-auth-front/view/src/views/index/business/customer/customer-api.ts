...
import { CustomerInfoDetail, CustomerInfoForm, CustomerInfoSeachRequest } from './interface/customer'

export const CustomerInfoPagedApi = (pageRequest: KWRequest.PageRequest<CustomerInfoSeachRequest>): Promise<KWResponse.PageResult<CustomerInfoDetail>> => request.post('customer/getCustomerInfoByPaged', pageRequest)
