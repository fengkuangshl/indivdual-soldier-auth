...
import com.key.win.security.annotation.PostAuthorize;
...
public class PostAuthorizeAOP {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());


    @After("@annotation(postAuthrize)")
    public void permissionProcess(JoinPoint point, PostAuthorize postAuthrize) throws Throwable {
        String value = postAuthrize.value();
