...
public class SysDataLogHandle extends BaseDataLog {
    ...
    public void setting() {
        // 设置排除某张表、某些字段
        this.addExcludeTableName(IndividualSoldierAuthConstantUtils.MODEL_CREATE_DATE)
                .addExcludeFieldName(IndividualSoldierAuthConstantUtils.MODEL_UPDATE_DATE)
                .addExcludeFieldName(IndividualSoldierAuthConstantUtils.MODEL_CREATE_USER_ID)
                .addExcludeFieldName(IndividualSoldierAuthConstantUtils.MODEL_UPDATE_USER_ID)
                .addExcludeFieldName(IndividualSoldierAuthConstantUtils.MODEL_CREATE_USER_NAME)
                .addExcludeFieldName(IndividualSoldierAuthConstantUtils.MODEL_UPDATE_USER_NAME)
                .addExcludeFieldName(IndividualSoldierAuthConstantUtils.MODEL_ENABLE_FLAG);
    }
