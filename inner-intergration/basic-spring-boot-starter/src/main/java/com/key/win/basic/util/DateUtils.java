...
public class DateUtils {
    ...
    public static Date strToTime2(String strDate) {
    ...
    * @return
    */
  public static Date strToDate_yyyyMMdd(String strDate) {
     ...
     * @return
     */
    public static String dateToYYYY年MM月DD日(Date dateDate) {
        SimpleDateFormat formatter = new SimpleDateFormat(DATE_PATTERN_yyyy年MM月dd日);
        String dateString = formatter.format(dateDate);
        return dateString;
    }
